...
from mauimic import kickstart
from mauimic.fs import *
from mauimic.imager.baseimager import BaseImageCreator
...
class RawImageCreator(BaseImageCreator):
    ...
    def __write_dracut_conf(self, path):
        ...
        if not self.target_arch or not self.target_arch == "x86_64":
            if not os.path.exists(self._instroot + "/lib64"):
